...
-- First insert the values into the category table
...
(select idCategory from StoreInventory.Category where name = 'Electronics'), 
...
(select idCategory from StoreInventory.Category where name = 'Kitchen'), 
...
(select idCategory from StoreInventory.Category where name = 'Home Office'), 
...
(select idCategory from StoreInventory.Category where name = 'Outdoor Living'), 
